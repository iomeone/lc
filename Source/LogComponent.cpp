...
LogComponent::LogComponent ()
{
    ...
    textEditor->setBounds (24, 16, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="LogComponent" componentName=""
  ...
  <TEXTEDITOR name="new text editor" id="baab8dcdeee9dc61" memberName="textEditor"
              virtualName="" explicitFocusOrder="0" pos="24 16 150 24" initialText=""
